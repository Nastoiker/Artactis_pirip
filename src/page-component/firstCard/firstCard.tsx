  ...
  return (
    <div className=" text-white z-10 relative top-20 BackGroundFont my-10 min-h-[900px]">
      ...
      <div className=" border w-[90vw] m-10  p-5 lg:ml-48 space-y-8 lg:w-[900px] lg:w-1/2 lg:w-1/3 h-fit border-4 border-red-800">
        ...
        <p
          className={
            "text-start mt-32  leading-8 z-10 w-fit xl:w-5/6 break-words"
          }
        >
          "Арктические просторы" - тур, включающий поездку на северо-запад
          Архангельской области, посещение древнего города Каргополя, местного
          музея культуры и быта народов Русского Севера, посещение нац. парка
          “Русская Арктика”, рыбалка на острове Мудьюг а также прогулку по реке
          Северной Двине с возможностью лицезреть северное сияние.
        </p>
      </div>
    </div>
  );
