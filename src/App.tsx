  ...
  return (
    ...
    <Parallax ref={parallax} >
      <ParallaxLayer offset={0.2} speed={-0.3} style={{ pointerEvents: 'none' }}>
        <img src={Bird1} className={" relative h-auto z-50 w-full"} style={{ width: 'auto', marginLeft: '70%' }} />
        <img src={Bird2} className={" relative z-50 w-full"}  style={{ display: 'block', width: 'auto', marginLeft: '55%' }} />
      ...
      <ParallaxLayer offset={2} speed={0.8} style={{ opacity: 1 }}>
          <img src={Bird4} className={" relative z-50 w-full"} style={{ display: 'block', width: '20%', marginLeft: '70%' }} />
          <img src={Bird5}  className={" relative z-50 w-full"} style={{ display: 'block', width: '20%', marginLeft: '40%' }} />
      </ParallaxLayer>
      ...
      <ParallaxLayer offset={0.5} speed={0.2} style={{ opacity: 1 }}>
          <img src={Bird3}  className={" relative z-50 w-full"} style={{ display: 'block', width: '30%', marginLeft: '15%' }} />

          <img src={Bird1} className={" relative z-50 w-full"} style={{ width: '25%', marginLeft: '70%' }} />
        <img src={Bird6} className={" relative z-50 w-full"} style={{ display: 'block', width: 'auto', marginLeft: '10%' }} />
      </ParallaxLayer>
    <div>
