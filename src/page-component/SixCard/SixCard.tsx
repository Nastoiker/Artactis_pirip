...
export const SixCard = () => {
    return <div className={"min-h-screen  max-h-full relative   "}>
        <img className="w-full max-h-[900px] min-h-1/3 cover absolute sm:bottom-0" src={Image} alt=""/>

        <div className={"mx-5 md:mx-52   relative "}>
            <div className="">
                <div className={"absolute h-fit top-72 sm:top-auto left-0 mx-auto  sm:w-96  z-50 right-0 flex space-y-20"}>
